...
const ContactForm = () => {
    ...
    return (
        <>
            <Head>
                <title>Contact Plombier à Nice – Demandez un devis gratuit</title>
                <meta
                    name="description"
                    content="Besoin d’un plombier à Nice ? Contactez-nous dès maintenant pour une intervention rapide, un diagnostic ou une mise aux normes. Réponse garantie en moins de 24h."
                />
            </Head>

            <section
                id="contact-plombier-nice"
                aria-label="Formulaire de contact pour dépannage plomberie à Nice"
                ...
                {state.succeeded ? (
                    ...
                    >
                        <input
                            type="hidden"
                            name="_subject"
                            value="Nouvelle demande – Formulaire plombier Nice"
                        />
                        ...
                        <div className="flex justify-center mt-4">
                            <button
                                type="submit"
                                className="mt-4 w-fit px-6 py-2 bg-[#13727B] text-white font-semibold  hover:bg-[#0e5a61] transition col-span-2"
                            >
                                Envoyer ma demande
                            </button>
                        </div>
